...
var ini = function(cbfn){
  ...
  setbyte(
    config.init[0],config.cmd,config,
    function(){
      setbyte(
        config.init[1],config.cmd,config,
        function(){
          setbyte(
            config.init[2],config.cmd,config,
            function(){
              setbyte(
                config.init[3],config.cmd,config,
                function(){
                  setbyte(
                    config.init[4],config.cmd,config,
                    function(){
                      setbyte(
                        config.init[5],config.cmd,config,
                        cbfn
                      )
                    }
                  )
 ...
 *
 * @param bits a integer representation of the bit pattern resp. the bit representation of a character
