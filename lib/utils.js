...
var ini = function(cbfn){
  ...
  setbyte(
    lcd.init[0],config.cmd,config,
    function(){
      setbyte(
        lcd.init[1],config.cmd,config,
        function(){
          setbyte(
            lcd.init[2],config.cmd,config,
            function(){
              setbyte(
                lcd.init[3],config.cmd,config,
                function(){
                  setbyte(
                    lcd.init[4],config.cmd,config,
                    function(){
                      setbyte(
                        lcd.init[5],config.cmd,config,
                        cbfn
                      )
                    }
                  )
