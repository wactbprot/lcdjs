        ...
        .export(11,
                {direction: 'out',
                 ready: function() {
                     ...
                     lcd_e  = gpio
                         .export(10, {direction: 'out',
                                      ready: function() {
                                          console.log("go for 10");
                                          lcd_d4 = gpio
                                              .export(4,  {direction: 'out',
                                                           ready: function() {
                                                               console.log("go for 6");
                                                               lcd_d5 = gpio
                                                                   .export(5,  {direction: 'out',
                                                                                ready: function() {
                                                                                    console.log("go for 5");
                                                                                    lcd_d6 = gpio
                                                                                        .export(6,  {direction: 'out',
                                                                                                     ready: function() {
                                                                                                         console.log("go for 4");
                                                                                                         lcd_d7 = gpio
                                                                                                             .export(1,  {direction: 'out',
                                                                                                                          ready: function() {
...
var lcd_byte = function(bits, mode, cbfn){
    ...
    var fn25 = function(){
        console.log("25");
        // High bits
        lcd_d4.reset(function(){
            console.log("reset d4");
            lcd_d5.reset(function(){
                console.log("reset d5");
                lcd_d6.reset(function(){
                    console.log("reset d6");
                    lcd_d7.reset(function(){
                        if( bits&filter[0]==filter[0]){
                            lcd_d4.set(
                                function(){console.log("set d4");
                                          });
                        }
                        if( bits&filter[1]==filter[1]){
                            lcd_d5.set(
                                function(){console.log("set d5");
                                          );
                            }
                            
                            if( bits&filter[2]==filter[2]){
                                lcd_d6.set(
                                    function(){console.log("set d6");
                                              );
                                }
                                
                                if( bits&filter[3]==filter[3]){
                                    lcd_d7.set(
                                        function(){console.log("set d7");
                                                  );
                                    }
                                })
                        })
